...
public class User {
    ...
    public User(int user_id, String username, String email,String tel, String password, String role, String image_name,int status, ImageView img) {
    ...
    public User(int user_id, String username, String email,String tel, String password, String role, String image_name, int status) {
        this.user_id = user_id;
        this.username = username;
        this.email = email;
        this.tel = tel;
    ...
    public User(int user_id, String username, String email,String tel, String password,String image_name) {
        this.user_id = user_id;
        this.username = username;
        this.email = email;
        this.tel = tel;
    ...
    public User(String username, String email, String tel, String password, boolean role, String image_name, int status) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public String toString2(){
        return "User{" + "user_id=" + user_id + ", username=" + username + ", email=" + email + ", tel=" + tel +", password=" + password +",role=" + role +", image_name=" + image_name +", status=" + status +'}';
    }
