...
public class PostService implements IService<Post>{
    ...
    public void create(Post post) throws SQLException {
        String sql = "INSERT INTO Post (room_id, author, content, img_url , user_id) " +
                "VALUES ('" + post.getRoom_id() + "', '" + post.getAuthor() + "', '" +
                post.getContent() + "', '" + post.getImg_url() + "', '" + post.getUser_id() + "')";
    ...
    public void update(Post post) throws SQLException {
        String sql = "UPDATE Post SET room_id = ?, author = ?, content = ?, img_url = ?, user_id = ?  where id = ?";
    ...
    public List<Post> readByRoomId(int room_id) throws SQLException {
        ...
        String roomCheckSql = "SELECT COUNT(*) AS count FROM Room WHERE id = ?";
